...
public class CalculatorSoapProxy implements com.calculatorservice.CalculatorSoap {
  private String _endpoint = null;
  private com.calculatorservice.CalculatorSoap calculatorSoap = null;
  ...
  private void _initCalculatorSoapProxy() {
    try {
      calculatorSoap = (new com.calculatorservice.CalculatorLocator()).getCalculatorSoap();
  ...
  public com.calculatorservice.CalculatorSoap getCalculatorSoap() {
    if (calculatorSoap == null)
      _initCalculatorSoapProxy();
