...
public class CalculatorLocator extends org.apache.axis.client.Service implements com.calculatorservice.Calculator {
    ...
    public com.calculatorservice.CalculatorSoap getCalculatorSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.calculatorservice.CalculatorSoapStub _stub = new com.calculatorservice.CalculatorSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.calculatorservice.CalculatorSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.calculatorservice.CalculatorSoapStub _stub = new com.calculatorservice.CalculatorSoapStub(new java.net.URL(CalculatorSoap_address), this);
                _stub.setPortName(getCalculatorSoapWSDDServiceName());
                return _stub;
            }
        }
