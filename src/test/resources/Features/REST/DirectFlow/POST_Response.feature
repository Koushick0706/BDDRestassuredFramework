...
Scenario Outline: Check if user is able to submit POST API request and Checks The Status Code
  ...
  #Check if user is able to submit POST API request and Checks The Content_Type
    ...
    |"RequisAPI_Post_User"|"Getdata"|"DirectFlow/Createuser.json"|"Type"|
    |"Swagger_Post_Pet"|"Getdata"|"DirectFlow/Postpet.json"|"Type"|
    |"Swagger_Post_Inventory"|"Getdata"|"DirectFlow/SwaggerStore.json"|"Type"|
